...
void DisplayStyle_Portrait () {
  ...
  if (stringComplete) {
    ...
    /* CPU Outline, */
    tft.drawRoundRect  (0,  0, 240, 120, 8,    ILI9341_RED);
    ...
    /* Blank CPU PCB BMP, */
    tft.drawBitmap(16, 25, CPU3_BMP, 82, 82, ILI9341_RED);
...
#define ILI9341_updateBox  ILI9341_BLACK // Default for normal running
    ...
    */
    ...
    tft.drawBitmap(16, 268, RAM_BMP, 80, 30, ILI9341_YELLOW);
