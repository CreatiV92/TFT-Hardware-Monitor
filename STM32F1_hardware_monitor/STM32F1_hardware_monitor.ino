...
/*
  ...
  Modified by @CreatiV92 removed unnecessary, simplified the setup.
...
void activityChecker() {
  ...
  if (!activeConn) {
    ...
    tft.fillScreen(ILI9341_BLACK);
    tft.setRotation(drt);// Rotate the display at the start:  0, 1, 2 or 3 = (0, 90, 180 or 270 degrees)
